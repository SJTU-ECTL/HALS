...
public:
    ...
    BigInt GetOutpRange(ll iPatt, ll lsb, ll msb, bool isSign) const;
    BigInt GetTempOutpRange(ll iPatt, ll lsb, ll msb, bool isSign) const;
    ...
    double GetMeanErrDist(const Simulator & oth_smlt, bool isSign, int outputNum = 1, bool isCheck = false) const;
    double GetMeanSquareErr(const Simulator & oth_smlt, bool isSign, int outputNum = 1, bool isCheck = false) const;
    double GetMeanAbsPercentageErr(const Simulator & oth_smlt, bool isSign, int outputNum = 1, bool isCheck = false) const;
    std::vector<double> GetMeanAbsPercentageErrVector(const Simulator & oth_smlt, bool isSign, int outputNum = 1, bool isCheck = false) const;
