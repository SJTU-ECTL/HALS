...
if(capture && !pattern_dir.empty() && cycle<4097){for(int j=0;j<128;++j) pattern_files[0]<<char('0'+((dut.pi0[j/32] >> (j%32))&1));pattern_files[0]<<"\n";}
if(capture && !pattern_dir.empty() && cycle<4097){for(int j=0;j<128;++j) pattern_files[1]<<char('0'+((dut.pi1[j/32] >> (j%32))&1));pattern_files[1]<<"\n";}
if(capture && !pattern_dir.empty() && cycle<4097){for(int j=0;j<128;++j) pattern_files[2]<<char('0'+((dut.pi2[j/32] >> (j%32))&1));pattern_files[2]<<"\n";}
if(capture && !pattern_dir.empty() && cycle<4097){for(int j=0;j<112;++j) pattern_files[3]<<char('0'+((dut.pi3[j/32] >> (j%32))&1));pattern_files[3]<<"\n";}
