...
static constexpr int widths[]={35,35,35,35}, signs[]={1,1,1,1};
...
emit({uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383)),uint16_t(randv(-16384,16383))});
 ...
 if(!pattern_dir.empty()){pattern_files.emplace_back(pattern_dir+"/hals_interp_k1.pattern");
pattern_files.emplace_back(pattern_dir+"/hals_interp_k2.pattern");
pattern_files.emplace_back(pattern_dir+"/hals_interp_k3.pattern");
pattern_files.emplace_back(pattern_dir+"/hals_interp_k4.pattern");}
...
if(capture && !pattern_dir.empty() && pattern_count<4096){for(int j=0;j<128;++j) pattern_files[0]<<char('0'+((dut.pi0[j/32] >> (j%32))&1));pattern_files[0]<<"\n";}
if(capture && !pattern_dir.empty() && pattern_count<4096){for(int j=0;j<128;++j) pattern_files[1]<<char('0'+((dut.pi1[j/32] >> (j%32))&1));pattern_files[1]<<"\n";}
if(capture && !pattern_dir.empty() && pattern_count<4096){for(int j=0;j<128;++j) pattern_files[2]<<char('0'+((dut.pi2[j/32] >> (j%32))&1));pattern_files[2]<<"\n";}
if(capture && !pattern_dir.empty() && pattern_count<4096){for(int j=0;j<112;++j) pattern_files[3]<<char('0'+((dut.pi3[j/32] >> (j%32))&1));pattern_files[3]<<"\n";}
++pattern_count;
