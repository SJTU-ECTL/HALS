...
// (8, 10)
tmp_real = s8_0 + s10_0;  tmp_imag = s8_1 + s10_1;
s10_0 = s8_0 - s10_0;     s10_1 = s8_1 - s10_1;
s8_0 = tmp_real;          s8_1 = tmp_imag;
...
// (9, 11)
tmp_real = s9_0 + s11_0; tmp_imag = s9_1 + s11_1;
tmp_real2 = s9_0 - s11_0; tmp_imag2 = s9_1 - s11_1;
tmp1 = (tmp_real2 * 16'sh0000) - (tmp_imag2 * 16'shff00);
tmp2 = (tmp_real2 * 16'shff00) + (tmp_imag2 * 16'sh0000);
tmp_sha = tmp1[23:8]; tmp_shb = tmp2[23:8];
s11_0 = tmp_sha; s11_1 = tmp_shb;
...
// (8, 9)
tmp_real = s8_0 + s9_0;   tmp_imag = s8_1 + s9_1;
s9_0 = s8_0 - s9_0;       s9_1 = s8_1 - s9_1;
s8_0 = tmp_real;          s8_1 = tmp_imag;

// (10, 11)
tmp_real = s10_0 + s11_0; tmp_imag = s10_1 + s11_1;
s11_0 = s10_0 - s11_0;    s11_1 = s10_1 - s11_1;
s10_0 = tmp_real;         s10_1 = tmp_imag;
